...
> Owner: `rules/nextc-claude/agents.md`. Update here when adding, removing, or reassigning a model/effort tier on any agent.

Authoritative roster of agent → model+effort assignments. Consulted when writing or invoking a specific agent. The decision-logic prose lives in `agents.md`.
...
| `ie-jtbd` | sonnet | high |
| `ie-ost` | sonnet | high |
| `ie-morphological` | sonnet | high |
| `ie-assumption-reversal` | sonnet | high |
| `ie-blue-ocean` | sonnet | high |
| `ie-wardley` | sonnet | high |
| `ie-seven-powers` | sonnet | high |
| `ie-mom-test` | sonnet | high |
