...
Use available dead-code analysis tools for the detected project type:
- JavaScript/TypeScript: knip, depcheck, ts-prune
- Python: vulture, autoflake
- Go: staticcheck, go vet
- Rust: cargo clippy, cargo udeps
- Dart/Flutter: dart analyze --fatal-infos
- General: grep-based unused export/import analysis
